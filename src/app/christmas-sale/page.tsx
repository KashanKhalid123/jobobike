...
export default function BlackWeekPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center space-y-6 md:space-y-10">
            ...
            <div className="flex justify-center gap-2 md:gap-6 py-4 md:py-8">
              <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3 md:p-8 min-w-[70px] md:min-w-[130px] shadow-2xl transform hover:scale-105 transition-transform">
                <div className="text-3xl md:text-6xl font-bold text-[#c41e3a] tabular-nums">{timeLeft.days}</div>
                <div className="text-xs md:text-sm text-gray-600 mt-1 md:mt-2 font-medium">DAGER</div>
              </div>
              <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3 md:p-8 min-w-[70px] md:min-w-[130px] shadow-2xl transform hover:scale-105 transition-transform">
                <div className="text-3xl md:text-6xl font-bold text-[#165b33] tabular-nums">{timeLeft.hours}</div>
                <div className="text-xs md:text-sm text-gray-600 mt-1 md:mt-2 font-medium">TIMER</div>
              </div>
              <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3 md:p-8 min-w-[70px] md:min-w-[130px] shadow-2xl transform hover:scale-105 transition-transform">
                <div className="text-3xl md:text-6xl font-bold text-[#c41e3a] tabular-nums">{timeLeft.minutes}</div>
                <div className="text-xs md:text-sm text-gray-600 mt-1 md:mt-2 font-medium">MIN</div>
              </div>
              <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3 md:p-8 min-w-[70px] md:min-w-[130px] shadow-2xl transform hover:scale-105 transition-transform">
                <div className="text-3xl md:text-6xl font-bold text-[#165b33] tabular-nums animate-pulse">{timeLeft.seconds}</div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <Link 
                href="/cycle"
                className="inline-block bg-white hover:bg-gray-100 text-[#c41e3a] text-lg font-semibold px-12 py-5 rounded-full transition-all transform hover:scale-105 shadow-2xl"
              >
                Handle nå →
              </Link>
            </div>
      ...
      {/* Final CTA */}
      <section className="bg-gradient-to-r from-[#c41e3a] to-[#165b33] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link 
            href="/cycle"
            className="inline-block bg-white hover:bg-gray-100 text-[#c41e3a] text-lg font-normal px-10 py-4 rounded-md transition-all"
          >
            Handle nå
          </Link>
        </div>
